...
function AdminConfigurationPage() {
  ...
  const [roleConfirm, setRoleConfirm] = useState<{
    open: boolean;
    email: string;
    action: 'elevateInstructor' | 'demoteInstructor' | 'elevateAdmin' | 'demoteAdmin';
    targetRole: string;
  }>({ open: false, email: '', action: 'elevateInstructor', targetRole: '' });
  ...
  async function handleElevateToInstructor(email: string) {
    setRoleConfirm({ open: true, email, action: 'elevateInstructor', targetRole: 'instructor' });
  }

  async function handleDemoteInstructor(email: string) {
    setRoleConfirm({ open: true, email, action: 'demoteInstructor', targetRole: 'student' });
  }
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription style={{ color: UI_COLORS.text.body }}>
              {roleConfirm.action === 'elevateInstructor' && `Are you sure you want to elevate ${roleConfirm.email} to instructor?`}
              {roleConfirm.action === 'demoteInstructor' && `Are you sure you want to demote ${roleConfirm.email} from instructor to student? This will also remove all their instructor enrollments.`}
